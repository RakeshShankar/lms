...
@Entity
@IdClass(MultipleQuestionListenPK.class)
@Table(name = "multiplequestionlisten")
public class MultipleQuestionListen implements Serializable {
	...
	public String toString() {
		return "MultipleQuestionListen [index=" + index + ", name=" + name + ", auto_evaluate=" + auto_evaluate
