...
@Entity
@Table(name = "multiplequestionexcercises")
public class MultipleQuestionExcercises {
	...
	public String toString() {
		return "MultipleQuestionExcercises [index=" + index + ", name=" + name + ", auto_evaluate=" + auto_evaluate
